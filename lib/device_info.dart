...
class AndroidDeviceInfo {
  ...
  @override
  String toString() {
    return 'AndroidDeviceInfo{version: $version, board: $board, bootloader: $bootloader, brand: $brand, device: $device, display: $display, fingerprint: $fingerprint, hardware: $hardware, host: $host, id: $id, manufacturer: $manufacturer, model: $model, product: $product, supported32BitAbis: $supported32BitAbis, supported64BitAbis: $supported64BitAbis, supportedAbis: $supportedAbis, tags: $tags, type: $type, isPhysicalDevice: $isPhysicalDevice, androidId: $androidId}';
  }
...
class IosDeviceInfo {
  ...
  @override
  String toString() {
    return 'IosDeviceInfo{name: $name, systemName: $systemName, systemVersion: $systemVersion, model: $model, localizedModel: $localizedModel, identifierForVendor: $identifierForVendor, isPhysicalDevice: $isPhysicalDevice, utsname: $utsname}';
  }
